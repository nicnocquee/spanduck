                        ...
                        <Menu.Button className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2">
                          ...
                          <div className="h-8 w-8 rounded-full bg-accent flex items-center justify-center">
                            <span className="text-white font-semibold">
                              {data?.user_metadata?.name?.split(" ")?.[0]?.[0]}
                            </span>
                          </div>
                        </Menu.Button>
                      </div>
              ...
              <Disclosure.Panel className="sm:hidden">
                <div className="space-y-1 pt-2 pb-3">
                  {navigation.map((item) => (
                    <Disclosure.Button
                      ...
                      className={classNames(
                        item.href === router.pathname
                          ? "bg-indigo-50 border-accent text-accent"
                ...
                <div className="border-t border-gray-200 pt-4 pb-3">
                  <div className="flex items-center px-4">
                    <div className="h-8 w-8 rounded-full bg-accent flex flex-shrink-0 items-center justify-center">
                      <span className="text-white font-semibold">
                        {data?.user_metadata?.name?.split(" ")?.[0]?.[0]}
                      </span>
                    </div>
